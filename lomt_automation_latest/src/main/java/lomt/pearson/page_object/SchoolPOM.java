...
public class SchoolPOM {
	...
	@FindBy(id="name")
	public WebElement txtSchoolProductLevelTitle;
	@FindBy(id="save-node")
	public WebElement btnSaveChanges;
	@FindBy(partialLinkText ="Curriculum Standard")
	public WebElement lnkCurriculumStandard;
	@FindBy(partialLinkText ="Product")
	public WebElement lnkSchoolProduct;
	@FindBy(partialLinkText ="Intermediaries")
	public WebElement lnkIntermedies;	
	@FindBy(xpath="//li[@class='root-node']//span[contains(@class,'rc-tree-switcher_close')]")
	public List<WebElement> parentNodeExpanded;	
	@FindBy(xpath="//li[@class='root-node']//span[contains(@class,'rc-tree-switcher rc-tree-switcher_open')]")	
	public List<WebElement> parentNodeCollapse;		
	@FindBy(xpath = "//li[@class='child-node']/span[contains(@class,'rc-tree-switcher_close')]")
	public List<WebElement> childNodeExpanded;
	@FindBy(xpath ="//li[@class='child-node']/span[contains(@class,'rc-tree-switcher_open')]")
	public List<WebElement> childNodeCollapse;
	@FindBy(className="node-edit-button")
	public WebElement btnEditNode;
	@FindBy(xpath ="//a[@class='breadcrumb-link']/span[text()='School Global']")
	public WebElement lnkSchoolGlobal;
	...
	@FindBy(xpath = "//span[contains(text(),'Visual Correlations')]")
	public WebElement lnkVisualCorrelation;
	...
	@FindBy(xpath = "//span[contains(text(),'Country')]/ancestor::div[@class='select-dropdown']//div[@class='Select-control']")
	public WebElement  countryDropdown;
	
	@FindBy(xpath = "//div[@class='select-dropdown']/div/div[@class='Select-menu-outer']/div/child::div")
	public List<WebElement>  countryDropdownList;
	
	@FindBy(xpath = "//span[contains(text(),'Authority')]/ancestor::div[@class='select-dropdown']//div[@class='Select-control']")
	public WebElement  authorityDropdown;
	
	@FindBy(xpath = "//div[@class='select-dropdown']/div/div[@class='Select-menu-outer']/div/child::div")
	public List<WebElement>  authorityDropdownList;
	
	@FindBy(xpath = "//span[contains(text(),'Curriculum Set')]/ancestor::div[@class='select-dropdown']//div[@class='Select-control']")
	public WebElement  curriculumSetDropdown;
	
	@FindBy(xpath = "//div[@class='select-dropdown']/div/div[@class='Select-menu-outer']/div/child::div")
	public List<WebElement>  curriculumSetDropdownList;
	...
	public WebElement  adoptedYear;
	
	@FindBy(xpath ="//input[@type='text']")
	public WebElement schoolProductDesctiption;
	...
	@FindBy(xpath = "//span[contains(text(),'Source URL')]/ancestor::div[@class='text-search-element']/input[@type='url']")
	public WebElement  csSourceURL;
	
	@FindBy(xpath = "//span[contains(text(),'Curriculum Info URL')]/ancestor::div[@class='text-search-element']/input[@type='url']")
	public WebElement  csInfoURL;
	...
	public WebElement getlnkSchoolGlobal(){
		return lnkSchoolGlobal;
	}
	public WebElement getlnkCurriculumStandard(){
		return lnkCurriculumStandard;
	}
	
	public WebElement getlnkSchoolProduct(){
		return lnkSchoolProduct;
	}
	
	public WebElement getlnkIntermedies(){
		return lnkIntermedies;
	}
