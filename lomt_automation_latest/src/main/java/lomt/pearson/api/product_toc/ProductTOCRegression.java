 ...
 *
 */
public class ProductTOCRegression extends BaseClass {

	private String currentLOB = null;
	...
	public ProductTOCRegression(WebDriver driver) {
		this.driver = driver;
	...
	public boolean ingestHEForAlignment() {
		...
		try {
			...
			hePom.getLearningTitleInputText().sendKeys("HE_Test_J001");
			Thread.sleep(4000);
