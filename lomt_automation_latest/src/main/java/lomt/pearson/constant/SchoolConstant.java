...
public class SchoolConstant {
	...
	public static String Ingestion_Subject = "Science";
	public static String Ingestion_Country = "United States";
	public static String Ingestion_Authority = "Iowa State Education Association";
	public static String Ingestion_Set = "new set";
	public static String Approved_Status = "Approved";
	
	public static String Reingestion_Subject = "Business";
	public static String SchoolProduct_Updated ="Product_updated";
	public static String CurriculumXMLFile = "Curriculum_IngestionTemplate_small.xml";
	
	public static String SchoolProductXLSXFile = "SchoolProduct.xlsx";
	
	public static String CurriculumXMLFile_Reingest = "Curriculum_ReingestionTemplate.xml";
	// Intermediatery Excel File for Ingestion
	public static String IntermediatersExcelFile = "Intermediary_Template.xlsx";
	public static String IntermediatersIncorrectExcelFile = "Intermediary_Template_Incorrect.xlsx";
