...
public class HEConstant {
	...
	//Title Value
//	public static String Title="Smoke Test";
	// public static Timestamp Title = new Timestamp(System.currentTimeMillis());
	
	
	public static String Title = RandomStringUtils.randomAlphanumeric(13); 
	...
	public static String ProductExcelFile = "Higher Ed_Product.xlsx"; 
	public static String ExternalFrameworkExcelFile = "Higher Ed_Ex Framework.xlsx";
	...
	public static String EducationalObjectiveExcelFile = "Higher Ed_EducationalObjective.xlsx";
